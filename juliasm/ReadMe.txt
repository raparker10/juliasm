...
-----------------------------------------------------------------------------
Mandelbrot  | Yes    | Yes    | Yes    |  Yes   |  Yes    | No     |  Yes   |
-----------------------------------------------------------------------------
Julia       | Yes    | Yes    | Yes    |  Yes   |  Yes    | No     |  Yes   |
-----------------------------------------------------------------------------
...
JuliasmApp_Dialog.cpp
Implements portions of the CJuliasmApp that manage dialog boxes.
...
To-do
-------------------------------------------------------------------------------
* Implement Mandelbrot functions in AVX2 / FMA
...
* Enhace the OpenCL object to expose all kernels in a program for all devices.
